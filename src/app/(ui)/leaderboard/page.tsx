  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center px-4 py-10 sm:py-16">
      ...
      <div className="relative z-10 w-full max-w-3xl mx-auto">
        <Link
          href="/puzzle"
          className="inline-block mb-6 text-sm !text-white !drop-shadow-md hover:!text-slate-200 !transition-colors"
        >
          &larr; Back to Puzzle
        </Link>

        <div className="!bg-white/10 !backdrop-blur-xl !border !border-white/20 !shadow-2xl rounded-2xl p-6 sm:p-10 w-full">
