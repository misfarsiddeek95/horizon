import { PILLAR_ICONS as PILLAR_ICONS_DATA } from "./pillarIcons";
...
export const PILLAR_ICONS: Record<PillarId, string> = {
  restore: PILLAR_ICONS_DATA.RESTORE,
  inspire: PILLAR_ICONS_DATA.INSPIRE,
  excite: PILLAR_ICONS_DATA.EXCITE,
  uplift: PILLAR_ICONS_DATA.UPLIFT,
  innovate: PILLAR_ICONS_DATA.INNOVATE,
};
