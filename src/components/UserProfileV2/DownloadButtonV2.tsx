...
export default function DownloadButtonV2({ download }: DownloadButtonV2Props) {
  return (
    <a
      ...
      className="group inline-flex items-center gap-2 rounded-full border border-white/20 bg-glass/50 px-6 py-3 text-sm font-semibold text-white shadow-lg backdrop-blur-xl transition-all duration-500 ease-out hover:-translate-y-1 hover:scale-[1.02] hover:border-brand-main hover:bg-brand-main hover:text-white hover:shadow-glass-hover focus-visible:ring-2 focus-visible:ring-brand-main focus-visible:ring-offset-2"
    >
